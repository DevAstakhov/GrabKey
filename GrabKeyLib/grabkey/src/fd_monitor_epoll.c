...
struct monitor_ctx_t* fd_monitor_create(int fd)
{
    ...
    struct epoll_monitor_context_t* ep_ctx = calloc(1, sizeof(struct epoll_monitor_context_t));
...
{
    struct epoll_monitor_context_t* ep_ctx = (struct epoll_monitor_context_t*)ctx;
